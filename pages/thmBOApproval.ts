...
export async function thmLicenceApproval(page: Page) {
...
await page.goto(sfbourl, { waitUntil: 'domcontentloaded' });
 ...
 await page.getByRole('button', { name: 'Validation required' }).click();
  await page.getByRole('alert').getByRole('option', { name: 'Approved' }).click();
